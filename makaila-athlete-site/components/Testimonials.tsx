...
const Testimonials = () => (
  <section id="testimonials" className="max-w-5xl mx-auto py-20 px-4 bg-bruin-white/80 rounded-xl shadow-inner">
    <h2 className="text-3xl sm:text-4xl font-heading font-bold mb-2 text-bruin-navy text-center">Testimonials</h2>
    <div className="w-16 h-1 bg-bruin-gold mx-auto mb-8 rounded-full" />
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      {testimonials.map((t, i) => (
        <Card key={i} className="bg-white border-2 border-bruin-gold shadow-md flex flex-col justify-between h-full p-4">
          <CardHeader>
